...
int islower(int c) {		return p[c] & _LOWER;				}
...
int ispunct(int c) {		return p[c] & _PUNCT;				}

int iscntrl(int c) {		return p[c] & _CONTROL;				}

int
isalnum(int c)
{
	return p[c] & (_UPPER | _LOWER | _DIGIT);
}

int
isprint(int c)
{
	return p[c] & (_BLANK | _PUNCT | _UPPER | _LOWER | _DIGIT);
}

int
isgraph(int c)
{
	return p[c] & (_PUNCT | _UPPER | _LOWER | _DIGIT);
}

int
isalpha(int c)
{
	return p[c] & (_UPPER | _LOWER);
}
